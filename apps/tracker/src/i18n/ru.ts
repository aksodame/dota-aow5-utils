...
export const ru: Messages = {
  ...
  settings: {
    ...
    style: {
      title: 'Стиль трекера',
      blurb:
        'Как устроена сводка, а не только какого она цвета. «Минималистичный» даёт каждому числу одинаковую карточку — читайте то, за которым пришли. «Torchlight» выносит лучший дроп сессии крупно наверх, а всё остальное убирает в полосу мелких цифр под ним. «Dota» оставляет карточки минималистичного, но рисует их как родные панели игры — её цветами и её шрифтом.',
      ...
      dota: 'Dota',
      dotaFrame: 'Рамка вокруг трекера',
      dotaFrameHint: 'Выключено — секции парят над игрой отдельными панелями, как у самой Доты. Включено — лежат на одной плите в рамке.',
      dotaHint: 'Те же карточки, что в минималистичном, но в облике родных панелей Доты: грифельные плиты с фаской, слоты предметов, рамки редкости.',
    },
    appearance: {
      title: 'Внешний вид',
