...
export const zh: Messages = {
  ...
  settings: {
    ...
    style: {
      title: '追踪器样式',
      blurb:
        '数据如何排布，而不只是配色。“极简”给每个数据同样大小的卡片，让你自己挑要看的那个。“火炬之光”把本场最值钱的掉落放大置顶，其余的收进下方一条小字带里。“Dota”沿用极简的卡片，但画成游戏自带面板的样子 —— 用它的配色和字体。',
      minimal: '极简',
      ...
      dota: 'Dota',
      dotaFrame: '追踪器外框',
      dotaFrameHint: '关闭时，各区块像 Dota 自带面板一样各自浮在游戏上方；开启时，它们放在同一块带边框的底板上。',
      dotaHint: '极简样式的卡片，换上 Dota 自带面板的外观：带斜边的石板底色、物品格、稀有度边框。',
    },
    appearance: {
      title: '外观',
      transparent: '透明背景',
